...
export function WalletButton() {
  const { connected, connecting, address, walletName, openConnectModal, disconnect } = useWallet();
    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button data-testid="button-wallet-connected" className="hover-elevate active-elevate-2">
        ...
        <DropdownMenuContent align="end" className="w-64">
          ...
          <DropdownMenuSeparator />
          <DropdownMenuItem onClick={() => copyToClipboard(address)} data-testid="button-copy-address">
